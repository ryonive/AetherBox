...
public class QuestDebug : DebugHelper
{
    ...
    public unsafe override void Draw()
    {
        ...
        {
            Quest quest2;
            quest2 = TrySearchQuest(questName);
    ...
    {
        List<(SeString, int)> matchingRows;
        matchingRows = (from t in questNames.Select((SeString n, int i) => (n: n, i: i))
