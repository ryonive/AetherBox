...
namespace AetherBox.Features.Debugging
{
    public class IslandDebug : DebugHelper
    {
        ...
        {
            byte restDays1 = *MJIManager.Instance()->CraftworksRestDays;
            byte restDays2 = MJIManager.Instance()->CraftworksRestDays[1];
            byte restDays3 = MJIManager.Instance()->CraftworksRestDays[2];
            byte restDays4 = MJIManager.Instance()->CraftworksRestDays[3];
